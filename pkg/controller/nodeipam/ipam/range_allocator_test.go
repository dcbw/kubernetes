...
func TestAllocateOrOccupyCIDRSuccess(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			subNetMaskSize: 30,
			allocatedCIDRs: map[int][]string{
				0: []string{"127.123.234.64/30", "127.123.234.68/30", "127.123.234.72/30", "127.123.234.80/30"},
			},
			expectedAllocatedCIDR: map[int]string{
				0: "127.123.234.76/30",
			},
		...
		// TODO (khenidak) add the rest of  dual stack tests
	}
	...
	testCases := []releaseTestCase{
		{
			...
			subNetMaskSize: 30,
			allocatedCIDRs: map[int][]string{
				0: []string{"127.123.234.0/30", "127.123.234.4/30", "127.123.234.8/30", "127.123.234.12/30"},
			},
			expectedAllocatedCIDRFirstRound: nil,
			cidrsToRelease: [][]string{
				[]string{"127.123.234.4/30"},
			},
			expectedAllocatedCIDRSecondRound: map[int]string{
				0: "127.123.234.4/30",
			},
		},
		{
			...
			subNetMaskSize: 30,
			allocatedCIDRs: map[int][]string{
				0: []string{"127.123.234.4/30", "127.123.234.8/30", "127.123.234.12/30"},
			},
			expectedAllocatedCIDRFirstRound: map[int]string{
				0: "127.123.234.0/30",
			},
			cidrsToRelease: [][]string{
				[]string{"127.123.234.0/30"},
			},
			expectedAllocatedCIDRSecondRound: map[int]string{
				0: "127.123.234.0/30",
			},
