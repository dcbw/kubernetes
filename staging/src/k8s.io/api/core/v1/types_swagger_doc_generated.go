...
var map_NodeSpec = map[string]string{
	...
	"podCIDRs":      "PodCIDRs represents the list of ranges for CIDRs assigned to this node.",
}
...
var map_PodStatus = map[string]string{
	...
	"podIPs":                "IP addresses allocated to the pod. This list is inclusive, i.e. it includes the default IP address stored in the \"PodIP\" field, and this default IP address must be recorded in the 0th entry (PodIPs[0]) of the slice. The list is empty if no IPs have been allocated yet.",
}
